...
class Beamscanner:
    ...
    def initMSL(self):
        ...
        self.msl.zero(self.msl.X)
        self.msl.hold(self.msl.X)
        self.msl.zero(self.msl.Y)
        self.msl.hold(self.msl.Y)
        
        # Sets MSL motion parameters
        self.msl.setAccel(5000000, self.msl.X)
        self.msl.setDecel(5000000, self.msl.X)
        self.msl.setVelMax(100000, self.msl.X)
        self.msl.setAccel(5000000, self.msl.Y)
        self.msl.setDecel(5000000, self.msl.Y)
        self.msl.setVelMax(100000, self.msl.Y)
    ...
    def moveToCenter(self):
        ...
        self.msl.moveAbs(int(self.pos_x_center * self.conv_factor), self.msl.X)
        self.msl.moveAbs(int(self.pos_y_center * self.conv_factor), self.msl.Y)
        self.msl.hold(self.msl.X)
        self.msl.hold(self.msl.Y)
        self.msl.setHome(self.msl.X)
        self.msl.setHome(self.msl.Y)

    def initScan(self, Range):
        # Get range parameters for scan
        self.setRange(Range)
        # Moves to minimum position in range to begin scan
        self.msl.moveAbs(self.pos_x_min, self.msl.X)
        self.msl.moveAbs(self.pos_y_min, self.msl.Y)
        self.msl.hold(self.msl.X)
        self.msl.hold(self.msl.Y)
        
        # Gets initial position
        self.pos_x = self.msl.getPos(self.msl.X)
        self.pos_y = self.msl.getPos(self.msl.Y)
    ...
    def scan(self, res):
        ...
        while self.pos_y <= self.pos_y_max:
            ...
            if self.direction == "right":
                while self.pos_x <= self.pos_x_max:
                    ...
                    if self.pos_x != self.pos_x_max:
                        self.msl.moveRel(step, self.msl.X)
                        self.msl.hold(self.msl.X)
                        self.pos_x = int(self.msl.getPos(self.msl.X))
            ...
            self.msl.moveRel(step, self.msl.Y)
            self.msl.hold(self.msl.Y)
            self.pos_y = int(self.msl.getPos(self.msl.Y))
